...
El texto completo de `rubrica.md` v1.1 está insertado a continuación, **íntegro y sin resumir**: dimensiones, componentes verificables, escalas con sus valores, ejemplos por nivel y las veintisiete reglas de corte. Los encabezados de la rúbrica están anidados un nivel para no competir con las capas de este prompt; el contenido es idéntico al archivo `rubrica.md` del repositorio.

<!-- ===== INICIO RÚBRICA v1.1 — TEXTO COMPLETO, NO RESUMIR NI EDITAR ===== -->
...
Antes de evaluar, confirmá que entre los marcadores figuran las cinco dimensiones con sus tablas de componentes, sus escalas de cinco niveles y las reglas de corte numeradas.
