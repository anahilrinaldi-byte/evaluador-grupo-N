...
El texto completo de `rubrica.md` v1.1 se inserta a continuación, **íntegro y sin resumir**: dimensiones, componentes verificables, escalas con sus valores, ejemplos por nivel y las veintisiete reglas de corte.

<!-- ===== INICIO RÚBRICA — PEGAR AQUÍ EL CONTENIDO COMPLETO DE rubrica.md v1.1 ===== -->

[CONTENIDO COMPLETO DE rubrica.md v1.1]
